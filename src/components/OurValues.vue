...
.d3-values-contents p {
  margin-bottom: 2rem;
  font-size: 1.6rem;
}

.d3-values-contents p:nth-child(3) {
  margin-bottom: 4rem;
  font-size: 1.6rem;
}

.d3-values-contents>a {
  flex: 1;
  display: flex;
  justify-content: center;
  align-items: center;
...
.d3-values-contents-consulting,
.d3-values-contents-coaching {
  padding: 1rem;
